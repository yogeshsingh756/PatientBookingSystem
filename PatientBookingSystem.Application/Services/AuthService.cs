    ...
    public class AuthService : IAuthService
    {
        ...
        public async Task<ApiResponse<string>> VerifyOtpAndRegisterAsync(VerifyOtpDto dto)
        {
            ...
            var user = new User
            {
                ...
                Address = otpData.Address ?? string.Empty,
                Landmark = otpData.Landmark ?? string.Empty,
                HouseNumber = otpData.HouseNumber ?? string.Empty,
                Role = otpData.Role,
                IsVerified = true,
                CreatedAt = DateTime.UtcNow,
                PinCode = otpData.PinCode ?? string.Empty,
                IsActive = true,
